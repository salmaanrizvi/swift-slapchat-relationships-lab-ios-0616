...
class RecipientTableViewController: UITableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        recipients = store.fetchDataByEntityName("Recipient", key: "name") as! [Recipient]
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if let indexOfRecipient = tableView.indexPathForSelectedRow?.row {
            print("Index: \(indexOfRecipient)")
            destinationVC.recipient = self.recipients[indexOfRecipient]
        }
    }
